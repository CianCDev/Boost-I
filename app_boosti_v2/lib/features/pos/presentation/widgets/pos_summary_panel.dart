...
class PosSummaryPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color textSecondary = theme.textTheme.bodyMedium?.color ?? Colors.grey.shade600;
    final Color textPrimary = theme.textTheme.bodyLarge?.color ?? Colors.grey.shade800;
    final Color backgroundColor = theme.cardColor;
    final Color surfaceColor = theme.colorScheme.surfaceVariant.withOpacity(0.5);

    return Card(
      elevation: isMobile ? 1 : 2,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12),
        side: BorderSide(color: borderColor, width: isMobile ? 0.5 : 1),
      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildRow('Subtotal', '\$${subtotal.toStringAsFixed(2)}', fontSize, isMobile, theme),
            const SizedBox(height: 6),
            _buildRow('IVA (16%)', '\$${impuesto.toStringAsFixed(2)}', fontSize, isMobile, theme),
            Divider(
              height: 20,
  ...
  Widget _buildRow(String label, String value, double fontSize, bool isMobile, ThemeData theme) {
    final textSecondary = theme.textTheme.bodyMedium?.color ?? Colors.grey.shade600;
    final textPrimary = theme.textTheme.bodyLarge?.color ?? Colors.grey.shade800;
