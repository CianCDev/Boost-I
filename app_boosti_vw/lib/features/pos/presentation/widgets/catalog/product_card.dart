...
class _ProductCardState extends ConsumerState<ProductCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color cardBackground = isDark ? cardDark : Colors.white;
    ...
    final marcaNombreAsync = widget.producto.marcaSupabaseId != null
        ? ref.watch(
            marcaNombrePorSupabaseIdProvider(widget.producto.marcaSupabaseId!))
        : null;
                      ...
                      Positioned.fill(
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: _buildProductImage(colorScheme, isDark),
                          ),
                        ),
                      ),
  ...
  // ============================================================
  // IMAGEN DEL PRODUCTO (con loading + error handling)
  // ============================================================
  Widget _buildProductImage(ColorScheme colorScheme, bool isDark) {
    final url = widget.producto.imagenUrl;
