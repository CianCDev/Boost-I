...
// ✅ ELIMINADO: import '../../controllers/bcv_controller.dart';
    ...
    final appBar = AppBar(
      ...
      leading: Center(
        child: buildActionButton(
          ...
          onPressed: () => showTopProducts(context, ref),
        ),
      ),
      title: isMobile
          ? _BcvBadge(
      ...
      actions: [
        buildActionButton(
          ...
          onPressed: () => showSidePanel(context, ref),
        ),
...
// ============================================================
// CLASE PRIVADA _InventoryBadge (restaurada)
// ============================================================
...
// ============================================================
// CLASE PRIVADA _BcvBadge (restaurada)
// ============================================================
class _BcvBadge extends StatelessWidget {
  final dynamic bcvState; // Usamos dynamic para no depender de BcvController
